...
const {getMenuColors, getDEVColors, getThemeToggleColors, getFunctionalColors} = require('../utils/colors')
const {DEV} = require('../config/default')
...
function modifyVars(color) {
  ...
  const palettes = getDEVColors(_color, theme.mode)
