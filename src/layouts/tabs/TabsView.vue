  ...
  methods: {
    ...
    refresh(key, page) {
      ...
      if (key === this.activePage) {
        ...
        // In fact, the refresh is very fast, adding this delay is purely for the purpose of displaying the loading state for a while, so that the user can perceive the refreshing process
