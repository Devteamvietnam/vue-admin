    ...
    <a-row :gutter="24">
        ...
        <a-col :md="24" :lg="17">
            <a-card style="width: 100%" :bordered="false" :tabList="tabListNoTitle" :activeTabKey="noTitleKey" @tabChange="(key) => handleTabChange(key, 'noTitleKey')">
                <base-settings v-if="noTitleKey === 'settings'"></base-settings>
...
import BaseSettings from '@/pages/admin/account/settings/BaseSettings'
import Security from '@/pages/admin/account/settings/Security'
export default {
    data() {
        return {
